    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followed_pages', models.ManyToManyField(blank=True, null=True, related_name='followed_pages', to='core.page')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('requested_pages', models.ManyToManyField(blank=True, null=True, related_name='requested_pages', to='core.page')),
